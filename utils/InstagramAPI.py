...
class InstagramAPI:
    ...
    def getLocationFeed(self, locationId, maxid = ''):
        loc = 'feed/location/'+str(locationId)+'/?max_id='+maxid+'&rank_token='+self.rank_token+'&ranked_content=true&'
        print(loc)
        locationFeed = self.SendRequest('feed/location/'+str(locationId)+'/?max_id='+maxid+'&rank_token='+self.rank_token+'&ranked_content=true&')
        return locationFeed
